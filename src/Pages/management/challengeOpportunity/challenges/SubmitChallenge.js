...
const SubmitChallenge = () => {
    ...
    return (
        <Form className='col-lg-6' onSubmit={formik.handleSubmit}>
            ...
            <Textarea name='history' label='سابقه و پیشینه چالش:' formik={formik} />
            <Textarea name='actions' label='اقدامات انجام شده تاکنون:' formik={formik} />
            <Input name='host' label='مجری اقدامات:' formik={formik} />
            <Textarea name='results' label='نتیجه اقدامات:' formik={formik} />
            <Textarea name='suggests' label='راهکارهای پیشنهادی رفع چالش:' formik={formik} />
            <Input name='price' label='ارزش مالی رفع چالش:' formik={formik} />
            <FileUplaod
                maxNumber='1'
                images={images}
                setImages={setImages}
