...
const Profile = () => {
    return (
        <Wrapper pageTitle="پروفایل کاربری">
            <div className="page-wrapper">
                <BreadCrumb> پروفایل کاربری </BreadCrumb>
                ...
                <div className="col-md-12 userProfile animate__animated animate__fadeIn">
                    ...
                    <div className='userEditNavbar'>
                        <Link to="/edit-profile" ><CgProfile /> ویرایش آواتار</Link>
                        <Link to="/edit-profile" ><CgImage /> ویرایش کاور  </Link>
                        <Link to="/edit-profile" ><FaRegEdit />ویرایش اطلاعات</Link>
                        <Link to="/messages" ><BiMessageSquareDetail />پیام ها</Link>
                        <Link to="/account-info" ><FaUserFriends />دوستان</Link>
                    </div>
                </div>
                <div className='userPosts'>
                    <p className="text-center my-4">شما تاکنون در صفحه خود مطلبی منتشر نکرده‌اید</p>
                </div>
            </div>
        </Wrapper>
    )
